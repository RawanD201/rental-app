@extends('layouts.body-main', ['title' => __('titles.expeneseType.edit')])
...
@section('body-main')
    ...
    <div x-cloak x-show="open"
        ...
        <form action=" {{ route('expense.storeType') }}" name="form" method="post">
            @csrf
            <div class="flex flex-col justify-center items-center gap-3">
                <div class="flex justify-center text-center w-3/4 md:w-1/2 dir gap-2">
                    <input class="p-2 bg-gray-200 outline-none text-center rounded w-full" placeholder="جۆری خەرجی"
                        type="text" name="name">
                    <button type="submit"
            ...
            <table class="text-center w-full dir">
                <thead class="bg-gray-900 flex text-white w-full rounded">
                    <tr class="flex w-full justify-center">
                        ...
                        <th class="p-4 w-full">جۆری خەرجی</th>
